...
from provenance.constants import METADATA_DIRECTORY_NAME, METADATA_DIRECTORY_CONTENTS

from_key   = DootKey("from")
target_key = DootKey("target")

def verify_provenance_files(spec, state):
    raise NotImplementedError("TODO")

def build_provenance_directory(spec, state):
...
def copy_provenance_directory(spec, state):
