...
class BiowareInfinity(globber.LazyGlobMixin, globber.DirGlobMixin, globber.EagerFileGlobber, task_mixins.TargetedMixin):
    """
    Processing Infinity engine BIFF files using weidu
    """

    def __init__(self, name="bioware::biffs", locs=None, roots=None):
